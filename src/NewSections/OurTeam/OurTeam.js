    ...
    <div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="mx-auto mb-10 lg:max-w-xl sm:text-center">
          <p className="inline-block px-3 py-px mb-4 text-4xl border-2 shadow-lg  border-cyan-400 font-semibold tracking-wider text-teal-900 uppercase rounded-full bg-teal-accent-400">
            Our Team
          </p>
        </div>
        <div className="grid gap-10 mx-auto sm:grid-cols-2 lg:grid-cols-4 lg:max-w-screen-lg">
          ...
          <div>
            ...
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Shohanur Rahman </p>
              <p className="mb-5 text-xs text-gray-800">
                Good guy & CSE Student
              </p>
              <div className="flex items-center space-x-3 sm:justify-center">
                <a
                  href="/"
          ...
          <div>
            ...
            <div className="flex flex-col sm:text-center">
              <p className="text-lg font-bold">Alif Ahmed</p>
              <p className="mb-5 text-xs text-gray-800">
                Good guy & CSE Student
              </p>
              <div className="flex items-center space-x-3 sm:justify-center">
